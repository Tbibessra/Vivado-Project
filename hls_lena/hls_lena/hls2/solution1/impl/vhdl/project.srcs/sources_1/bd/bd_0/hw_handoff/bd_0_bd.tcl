...
proc create_root_design { parentCell } {
  ...
  set input_r [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 input_r ]
  ...
  set output_r [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 output_r ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000.0} \
   ] $output_r
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:sobel:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net hls_inst_output_r [get_bd_intf_ports output_r] [get_bd_intf_pins hls_inst/output_r]
  connect_bd_intf_net -intf_net input_r_0_1 [get_bd_intf_ports input_r] [get_bd_intf_pins hls_inst/input_r]
