...
// ==============================================================
#ifndef __sobel_fsqrt_32ns_cud__HH__
#define __sobel_fsqrt_32ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_fsqrt_32ns_cud) {
    ...
    SC_CTOR(sobel_fsqrt_32ns_cud):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
