...
// ==============================================================
#ifndef __sobel_sitofp_32s_bkb__HH__
#define __sobel_sitofp_32s_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sitofp_32s_bkb) {
    ...
    SC_CTOR(sobel_sitofp_32s_bkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {
